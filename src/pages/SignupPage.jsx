      ...
      <div className="h-full w-full bg-[#FFFFFF] md:w-[40%]">
        <div className="flex items-center justify-center">
          <div className="flex w-full flex-col items-center justify-center rounded-xl bg-white p-8">
            <img src={foodie} alt="Logo" style={{ width: "100px" }} />
            <h2 className="mb-4 text-center text-2xl font-semibold">
              Join Us Now!
            </h2>
            <h2 className="mb-4 text-center text-sm font-semibold text-[#22C55E]">
              Start by creating your FWG account
            </h2>
            {error && (
            ...
            <p className="mt-4 text-center text-gray-600">
              ...
              <Link to="/signin" className="text-[#22C55E]">
                Login
              </Link>
            </p>
          </div>
