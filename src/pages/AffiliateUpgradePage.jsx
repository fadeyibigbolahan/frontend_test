...
const AffiliateUpgradePage = () => {
    ...
    return (
        <div className="flex flex-col gap-y-4">
            ...
            <div className="flex flex-col gap-y-4">
                <h2 className="text-sm font-semibold md:text-lg">Select a package for your FWG Account upgrade</h2>
                            ...
                            {packages.map((p, index) => (
                                <div
                                    ...
                                    className={`relative flex w-[170px] cursor-pointer flex-row gap-2 rounded-md border bg-white p-2 hover:bg-[#22C55E50] md:w-[200px] ${
                                        clickedPackage?._id === p?._id ? "border-2 border-green-400" : ""
                                    }`}
                                >
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <h3 className="text-xs font-semibold text-black/50">NGN {p.price}</h3>
                                    </div>
                                    {user?.package === p?._id && (
                                        <Sparkles
                                            size={15}
                        ...
                        {clickedPackage && (
                            <div className="mt-4 flex flex-col items-start justify-start gap-4 md:w-1/2">
                                ...
                                <div className="flex flex-row gap-2 md:gap-4">
                                    <ul className="flex flex-col gap-2 md:gap-4">
                                        ...
                                        <li className="flex items-center justify-start gap-2 text-sm">
                                            ...
                                            NGN {clickedPackage.price * 0.2} Signup Bonus
                                        </li>
                                    </ul>
                                    <ul className="flex flex-col gap-2 md:gap-4">
                                        <li className="flex items-center justify-start gap-2 text-sm">
                                ...
                                <button
                                    ...
                                    className="flex w-full items-center justify-center rounded-md bg-[#22C55E] p-2 text-white hover:bg-black md:w-2/3"
                                >
